 ...
 * 			SETTING UP KEYS.JS
 *********************************************/
// TODO TOGETHER: Open .gitignore and add mapbox-api-lec.js. Add mapbox-api-lec.js file and import to mapbox html file. Your api keys are stored in mapbox-api-lec.js and are added to the .gitignore so they are protected
...
// })
function geo(){
    geocode("930 Everest, San Antonio, Tx 78209", mapboxToken).then(function(result) {
        console.log(result);
        map.flyTo(
            {center: result, zoom: 15, speed: 0.2, curve: 1}
        );
